...
interface SwitchFieldProps
	extends FieldProps<boolean>,
		Omit<HTMLProps<"input">, "name"> {
	children: ReactNode;
}

export const CustomSwitchField: FC<SwitchFieldProps> = ({
	name = "",
	children,
	...props
}) => {
...
interface HiddenFieldProps
	extends Pick<FieldProps<string | number | boolean>, "name"> {}
